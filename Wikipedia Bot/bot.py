...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="Assalomu alaykum, botimizga hush kelibsiz. Ba bot sizga Turli xil narsalar haqida ma'lumot beradi")
    except:
...
async def help_command(message:Message):
    ...
    try:
        db.add_user(full_name=full_name,telegram_id=telegram_id)
        await message.answer(text="Bu /start tugmasi orqali botimizni ishga tushirasiz\n")
    except:
        pass
